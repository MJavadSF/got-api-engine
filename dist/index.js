  ...
  return JSON.stringify(
    ...
    function(_k, v) {
      if (typeof v === "object" && v !== null) {
        ...
        const parentDepth = this !== null && typeof this === "object" && depthMap.has(this) ? depthMap.get(this) ?? 0 : 0;
...
var winstonLoaded = false;
async function tryCreateWinstonLogger(serviceName, debugEnabled, isDev) {
  try {
    ...
    const colorfulFormat = winston.format.combine(
      ...
      winston.format.printf(({ timestamp, level, message, requestId, userId, err, ...meta }) => {
        ...
        const errStr = err ? ` | err: ${JSON.stringify({
          code: err.code,
          message: err.message
        })}` : "";
...
async function createLogger(serviceName, debugEnabled = false, isDev = process.env.NODE_ENV !== "production") {
...
var GotApiEngine = class _GotApiEngine {
  constructor(config) {
    ...
    this.httpClient = got__default.default.extend({
      agent: {
        https: new https__default.default.Agent({
          keepAlive: true,
...
var BrowserStorageAuthProvider = class {
  constructor(storageKey = "auth_token", storage = "localStorage") {
...
var createStaticAuth = (token) => new StaticAuthProvider(token);
var createDynamicAuth = (fn) => new DynamicAuthProvider(fn);
var createNextAuthProvider = (getSession) => new NextAuthProvider(getSession);
var createBrowserStorageAuth = (key, storage) => new BrowserStorageAuthProvider(key, storage);
...
exports.BrowserStorageAuthProvider = BrowserStorageAuthProvider;
exports.DynamicAuthProvider = DynamicAuthProvider;
exports.GotApiEngine = GotApiEngine;
...
exports.createBrowserStorageAuth = createBrowserStorageAuth;
exports.createConsoleLogger = createConsoleLogger;
exports.createDynamicAuth = createDynamicAuth;
exports.createEngine = createEngine;
exports.createLogger = createLogger;
exports.createNextAuthProvider = createNextAuthProvider;
exports.createStaticAuth = createStaticAuth;
